    ...
    >
      <div className=" m-auto px-1 md:px-20 ">
        ...
        >
          ...
          <p className="text-lg md:text-xl font-semibold md:font-bold text-gray-400">
      ...
      {selectedProject && (
        <div
          ...
          className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90  py-12 "
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-2xl  overflow- relative px-3 py-4 my-24  "
          >
              {/* close model btn */}
              <div className="absolute -top-2 w-full flex justify-end  z-50">
                <button
                  onClick={() => setSelectedProject(null)}
                  className="bg-white/10 backdrop-blur-lg px-2 rounded-full mb-3 font-bold text-3xl hover:text-purple-500 "
                >
                  {" "}
                  &times;{" "}
                </button>
            ...
            <div className="w-full flex gap-5">
              <a
                ...
                className={`rounded-md shadow-2xl w-full px-2 md:px-8 py-2 inline-block mt-5 text-xs md:text-lg font-bold transition duration-300 text-center hover:scale-105 hover:bg-linear-to-r hover:from-[#8245ec] hover:to-[#a885f7]  btn-project-hover  border border-zinc-700 hover:border-0   ${
                  selectedProject.github === null
                    ...
                    : "btn-project-hover  hover:scale-105"
                }`}
              >
                {" "}
                View Code{" "}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`rounded-md shadow-2xl w-full px-2 md:px-8 py-2 inline-block mt-5 text-xs md:text-lg font-bold transition duration-300 text-center bg-linear-to-r from-[#8245ec] to-[#a885f7]  ${
                  selectedProject.webapp === null
                    ? " opacity-20 cursor-not-allowed "
                    : "btn-project-hover  hover:scale-105"
                }`}
              >
